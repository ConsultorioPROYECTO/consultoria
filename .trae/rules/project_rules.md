1. Always do Best practices for Framewrok: NextJS 15.4.5 | Tailwind 4.1 | Typescript | React
2. ESLint: @typescript-eslint/
3. For front end task:
    - try to use grid or flex do not use space-y or space-x
...
6. AI Context Optimization:
    ...
    - Maintain consistent patterns across the codebase for better AI understanding