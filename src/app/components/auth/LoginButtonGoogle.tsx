...
export default function LoginGoogle(): React.ReactElement {
  ...
  return (
    ...
    className="w-full bg-white hover:bg-gray-50 text-gray-950 font-semibold py-2 px-4 rounded-lg border border-gray-300 transition-colors duration-200 flex items-center justify-center"
  >
