            ...
            <div className="overflow-y-auto">
              ...
              <div className="pb-4 px-4">
                <FormContent
                  ...
                  openTimeSlotCombo={openTimeSlotCombo}
                  setOpenTimeSlotCombo={setOpenTimeSlotCombo}
...
interface FormContentProps {
  ...
  openTimeSlotCombo: boolean;
  setOpenTimeSlotCombo: React.Dispatch<React.SetStateAction<boolean>>;
      ...
      {isLoadingData ? (
        ...
        <form onSubmit={handleSubmit} className="grid gap-4">
          ...
          <div className="grid gap-2">
            ...
            <Popover open={openTimeSlotCombo} onOpenChange={setOpenTimeSlotCombo} modal={false}>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  role="combobox"
                  ...
                  className="w-full justify-between"
                  disabled={!formData.doctorId || !formData.date || !formData.serviceId || isLoadingTimeSlots}
                >
                  {formData.time || "Seleccionar hora disponible..."}
                  <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                </Button>
              </PopoverTrigger>
              <PopoverContent className="w-[280px] p-0">
                    ...
                    {isLoadingTimeSlots ? (
                      ...
                      <CommandEmpty>
                        {!formData.doctorId || !formData.date || !formData.serviceId
                          ? "Seleccione médico, fecha y servicio primero"
                        ...
                        {availableTimeSlots.map((slot, index) => {
                          ...
                          return (
                            <CommandItem
                              ...
                              value={timeDisplay}
                              onSelect={() => {
                                handleInputChange('time', startTime);
                                setOpenTimeSlotCombo(false);
                              }}
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
                                  formData.time === startTime ? "opacity-100" : "opacity-0"
                                )}
                              />
